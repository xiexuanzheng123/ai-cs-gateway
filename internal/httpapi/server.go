...
func NewServer(cfg config.Config) *gin.Engine {
	...
	router.GET("/api/customer-service/admin/quality-stats", chatHandler.QualityStats)
	...
	router.GET("/api/customer-service/admin/knowledge/:id/versions", chatHandler.ListKnowledgeVersions)
	router.POST("/api/customer-service/admin/knowledge/:id/publish", chatHandler.PublishKnowledge)
	router.POST("/api/customer-service/admin/knowledge/:id/versions/:version_id/rollback", chatHandler.RollbackKnowledge)
	...
	router.POST("/api/customer-service/admin/rag-eval-cases/seed", chatHandler.SeedRAGEvalCases)
